...
function Feed({ logout }) {
    ...
    const loadPosts = async () => {
        ...
        try {
            ...
            // Если постов нет — просто устанавливаем пустой массив (без моков!)
            ...
            // При ошибке — просто пустой массив, без моков
            setPosts([]);
            setToast({
    ...
    const handleEmojiClick = (emoji) => {
        ...
        if (remainingChars < emoji.length) return;
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            // Больше не создаём локальные посты-заглушки
        }
    };
